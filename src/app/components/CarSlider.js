         ...
         >
            {
               cars.map((car, index) => {
                  return (
                     <SwiperSlide key={index * car}>
                        <div className="w-full md:max-w-[385px] mx-auto sm:mx-0">
                           <Image src={car.image} width={380} height={284} alt={car.name}/>

                           <div className="flex justify-between">
                              <div>
                                 <div className="text-[13px] uppercase text-secondary">{car.type}</div>
                                 <div className="uppercase font-bold text-lg">{car.name}</div>
                                 <div className="text-accent mb-5 font-semibold uppercase">
                                    ${car.price}/day
                                 </div>
                              </div>
                           ...
                           <div className="flex gap-x-3 xl:gap-x-4 w-max mb-5">
                              {
                                 car.info.map((item, index) => {
                                    return <div key={index} className="flex flex-col items-center">
                                       ...
                                       <div className="uppercase text-[12px]">{item.text}</div>
                                    </div>
                                 })
                              }
                           </div>
